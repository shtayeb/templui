(function () {
  ...
  function setActiveTab(tabsId, value) {
    ...
    document.querySelectorAll(`[data-tui-tabs-trigger][data-tui-tabs-id="${tabsId}"]`).forEach(trigger => {
    ...
    document.querySelectorAll(`[data-tui-tabs-content][data-tui-tabs-id="${tabsId}"]`).forEach(content => {
  ...
  function setupInitialStates() {
    document.querySelectorAll('[data-tui-tabs]').forEach(container => {
      ...
      const activeTrigger = container.querySelector(`[data-tui-tabs-trigger][data-tui-tabs-state="active"]`) ||
