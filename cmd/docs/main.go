...
func main() {
	...
	mux.Handle("GET /docs/components/sidebar-fullscreen-sidebar", htmxHandler(pages.SidebarFullscreenSidebar()))
	mux.Handle("GET /docs/components/sidebar-fullscreen-floating", htmxHandler(pages.SidebarFullscreenFloating()))
	mux.Handle("GET /docs/components/sidebar-fullscreen-inset", htmxHandler(pages.SidebarFullscreenInset()))
